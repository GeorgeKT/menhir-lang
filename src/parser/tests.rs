...
fn test_precedence_4() {
    ...
    assert_eq!(
        ...
        bin_op(
            ...
            bin_op(
                BinaryOperator::And,
                name_ref("c", span(1, 11, 1, 11)),
                name_ref("d", span(1, 16, 1, 16)),
                span(1, 11, 1, 16)
            ),
            span(1, 1, 1, 16),
        )
...
"#,
    ...
    assert_eq!(
        ...
        match_expression(
            ...
            vec![
                match_case(
                    number_pattern(0, span(3, 5, 3, 5), &target),
                    number(1, span(3, 10, 3, 10), &target),
                    span(3, 5, 3, 10)
                ),
                match_case(
                    number_pattern(1, span(4, 5, 4, 5), &target),
                    number(2, span(4, 10, 4, 10), &target),
                    span(4, 5, 4, 10)
                ),
                match_case(
                    number_pattern(2, span(5, 5, 5, 5), &target),
                    number(3, span(5, 10, 5, 10), &target),
                    span(5, 5, 5, 10)
                ),
            ],
            span(2, 1, 5, 10)
