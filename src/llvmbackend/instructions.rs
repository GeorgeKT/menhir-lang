...
unsafe fn gen_unary_op(ctx: &Context, dst: &Var, operator: UnaryOperator, src: &Operand)
{
...
unsafe fn gen_binary_op(ctx: &Context, dst: &Var, op: BinaryOperator, left: &Operand, right: &Operand)
{
